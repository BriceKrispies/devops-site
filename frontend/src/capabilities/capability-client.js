 ...
 */
export function loadCapabilities(response) {
...
export function setCapabilitiesError(error) {
    _error = error;
    _loaded = false;
}
 ...
 */
export function toCapabilityShell(cap) {
    return {
        id: cap.key,
        name: cap.name,
        area: cap.area,
 ...
 */
export function toCapabilityShells(area) {
